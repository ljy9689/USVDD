...
% 已知的最优参数
bestParams.k = 130; % 例如，最优参数k的值
bestParams.gamma =   0.97789 ; % 例如，最优参数gamma的值
bestParams.scaleFactor = 0.2041; % 例如，最优参数scaleFactor的值
bestParams.g = 0.71651; % 例如，最优参数g的值
bestParams.f = 1.9335; % 例如，最优参数f的值
