...
% 已知的最优参数
bestParams.k = 125; % 例如，最优参数k的值
bestParams.gamma =   0.8318 ; % 例如，最优参数gamma的值
bestParams.scaleFactor = 2.7301; % 例如，最优参数scaleFactor的值
bestParams.g = 0.93625; % 例如，最优参数g的值
bestParams.f = 1.0492; % 例如，最优参数f的值
